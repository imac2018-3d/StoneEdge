...
public class SplineControllerInspector : Editor {
	public override void OnInspectorGUI() {
		...
		controller.currentSpline = (Spline)EditorGUILayout.ObjectField("Current Spline", controller.currentSpline, 
																																	typeof(Spline), true);
		controller.gravSpline = (Spline)EditorGUILayout.ObjectField("Gravity Spline", controller.gravSpline, 
																																typeof(Spline), true);
