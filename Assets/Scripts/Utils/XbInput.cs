...
internal class XbInputMappingsOSX: IXbInputMappings {
...
internal class XbInputMappings: IXbInputMappings {
#if UNITY_EDITOR_WIN || UNITY_STANDALONE_WIN
	IXbInputMappings m = new XbInputMappingsWindows ();
#elif UNITY_EDITOR_LINUX || UNITY_STANDALONE_LINUX
	IXbInputMappings m = new XbInputMappingsLinux ();
...
public static class XbInput {
	static XbInputMappings m = new XbInputMappings ();
