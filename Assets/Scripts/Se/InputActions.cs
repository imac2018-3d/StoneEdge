...
namespace Se {
	...
	public class Bindings {
		...
		public ButtonBinding MenuBack = new ButtonBinding(KeyCode.Backspace, XbButton.Back);
		public ButtonBinding MenuConfirm = new ButtonBinding(KeyCode.Return, XbButton.RStickClick);
